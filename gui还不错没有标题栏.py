...
from flet import (
    ...
    FloatingActionButton, Tabs, Tab, OutlinedButton
)
...
class TodoApp(ft.Column):
    def __init__(self):
        ...
        self.controls = [
            ft.Row(
                [ft.Text(value="待办事项", style=ft.TextStyle(font_family="FZLanTingHei", size=20, weight=ft.FontWeight.BOLD))],
...
def main(page: Page):
    ...
    page_sizes = {
        ...
        2: {"min_width": 380, "min_height": 520, "max_width": 800, "max_height": 600},
    ...
    home_content = ft.Column(
        [
            ft.Text("银行相关", size=16, weight=ft.FontWeight.BOLD, font_family="FZLanTingHei"),
        ],
        spacing=10,
    ...
    bank_export_content = ft.Column(
        [
            ft.Text("银行导出", size=16, weight=ft.FontWeight.BOLD, font_family="FZLanTingHei"),
            bank_dropdown,
            ft.Row(
                [
                    start_date,
    ...
    ai_content = ft.Column(
        [
            ft.Text("AI 对话", size=16, weight=ft.FontWeight.BOLD, font_family="FZLanTingHei"),
            ft.Container(
                content=ai_output,
                padding=5,
                border_radius=8,
    ...
    todo_content = ft.Column(
        [
            ft.Text("待办事项", size=16, weight=ft.FontWeight.BOLD, font_family="FZLanTingHei"),
            ft.Container(
                content=TodoApp(),
                padding=5,
                border_radius=8,
    ...
    settings_content = ft.Column(
        [
            ft.Text("日志", size=16, weight=ft.FontWeight.BOLD, font_family="FZLanTingHei"),
            ft.Container(
                content=log_area,
                padding=5,
                border_radius=8,
    ...
    # 页面配置
    pages = [
        {"icon": ft.Icons.ACCOUNT_BALANCE_OUTLINED, "selected_icon": ft.Icons.ACCOUNT_BALANCE, "label": "银行相关", "content": home_content},
        {"icon": ft.Icons.DOWNLOAD_OUTLINED, "selected_icon": ft.Icons.DOWNLOAD, "label": "银行导出", "content": bank_export_content},
        {"icon": ft.Icons.CHAT_OUTLINED, "selected_icon": ft.Icons.CHAT, "label": "AI", "content": ai_content},
        {"icon": ft.Icons.LIST_OUTLINED, "selected_icon": ft.Icons.LIST, "label": "待办", "content": todo_content},
    ]
