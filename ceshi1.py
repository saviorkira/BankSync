...
def main(page: Page):
    ...
    home_content = ft.Column(
        [
            # ft.Text("登录", size=16, weight=ft.FontWeight.BOLD, font_family="FZLanTingHei"),
        ],
        spacing=10,
    ...
    bank_export_content = ft.Column(
        [
            # ft.Text("导出", size=16, weight=ft.FontWeight.BOLD, font_family="FZLanTingHei"),
            bank_dropdown,
            ft.Row(
                [
                    start_date,
    ...
    # 页面配置
    pages = [
        {"icon": ft.Icons.LOGIN_OUTLINED, "selected_icon": ft.Icons.LOGIN_ROUNDED, "label": "登录", "content": home_content},
